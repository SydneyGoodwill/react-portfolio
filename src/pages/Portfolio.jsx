...
const Portfolio = () => {
  return (
    <div class="big-container">
      ...
      <p>You can view all of my code repositories on my  <a href="https://github.com/SydneyGoodwill">GitHub</a> profile!</p>
      <div class="card-container">
        <div class="col-mb-4">
          <div class="card-main">
            <img src="./assets/HomescreenDemo.png" class="card-img-top" alt="Snapshot"></img>
            <div class="card-body">
        ...
        <div class="col-mb-4">
          <div class="card-main">
            <img src="./assets/workdayscheduler.gif" class="card-img-top" alt="DayPlanner"></img>
            <div class="card-body">
        ...
        <div class="col-mb-4">
          <div class="card-main">
            <img src="./assets/screenshot.png" class="card-img-top" alt="CodeRefactor"></img>
            <div class="card-body">
        ...
        <div class="col-mb-4">
          <div class="card-main">
            <img src="assets/amalganation.jpg" class="card-img-top" alt="placeholder4"></img>
            <div class="card-body">
